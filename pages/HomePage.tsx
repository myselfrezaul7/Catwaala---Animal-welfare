      ...
      <div className="w-full">
        ...
        >
          ...
          <div className="relative text-center z-10 p-4">
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold drop-shadow-2xl">A Purrfect Friend Awaits.</h1>
        ...
        <section className="py-20">
          <div className="container mx-auto px-6 space-y-12">
              ...
              <div className="bg-slate-100/30 dark:bg-slate-800/30 backdrop-blur-lg border border-white/20 dark:border-slate-700/50 rounded-2xl shadow-xl p-8 md:p-12 text-center">
                  <h2 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-slate-100 mb-6">Our Mission</h2>
              ...
              <div className="bg-slate-100/30 dark:bg-slate-800/30 backdrop-blur-lg border border-white/20 dark:border-slate-700/50 rounded-2xl shadow-xl p-8 md:p-12 text-center">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-slate-100 mb-6">Your Support Saves Lives</h2>
              ...
              <div className="bg-slate-100/30 dark:bg-slate-800/30 backdrop-blur-lg border border-white/20 dark:border-slate-700/50 rounded-2xl shadow-xl p-8 md:p-12 text-center">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-slate-100 mb-6">Become a Volunteer</h2>
                  <p className="max-w-3xl mx-auto text-lg text-slate-700 dark:text-slate-300 leading-relaxed mb-8">
