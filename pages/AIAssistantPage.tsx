...
import { CatIcon, SendIcon } from '../components/icons';
...
const AIAssistantPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-88px)] container mx-auto p-4 max-w-3xl">
      <div className="text-center mb-6 pt-4">
        <h1 className="text-4xl font-bold text-slate-800 dark:text-slate-100">AI Vet Assistant</h1>
        <p className="text-lg text-slate-600 dark:text-slate-400">Ask general questions about pet health and care.</p>
      </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-3">
              ...
              <div className="bg-slate-200/50 dark:bg-slate-700/50 p-4 rounded-xl rounded-tl-none max-w-lg">
                <p className="text-slate-800 dark:text-slate-200">Hello! I'm CATWAALA's AI Assistant. How can I help you with your cat today?</p>
              </div>
            </div>
