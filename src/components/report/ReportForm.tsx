                                        ...
                                        <div className={`border-2 border-dashed rounded-3xl p-8 text-center transition-all cursor-pointer relative overflow-hidden ${imagePreview ? 'border-rose-500 bg-white' : 'border-stone-300 bg-stone-50 hover:bg-stone-100 hover:border-rose-300'}`}>
                                            ...
                                            {imagePreview ? (
                                                ...
                                                <div className="py-6">
                                                    ...
                                                    <p className="text-stone-400 text-sm mt-1">Tap to select from gallery <span className="text-rose-500 font-bold">(Max 10MB)</span></p>
                                                </div>
                                            )}
                                        </div>
                        ...
                        {currentStep === 4 && (
                            <div className="space-y-8 animate-in slide-in-from-right-8 fade-in duration-300">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {errors.contact && <p className="text-sm text-rose-500 font-bold ml-2">{errors.contact.message}</p>}
                                </div>
