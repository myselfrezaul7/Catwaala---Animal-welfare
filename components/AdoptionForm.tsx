          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <fieldset className="border-t border-slate-300 dark:border-slate-700 pt-5">
                <legend className="text-xl font-semibold text-slate-700 dark:text-slate-200 mb-3">Living Situation</legend>
                 <div>
                    <label className={labelStyles}>Type of Residence</label>
                    <div className="mt-2 flex flex-wrap gap-x-6 gap-y-2 text-slate-700 dark:text-slate-300">
                        <label className="flex items-center"><input type="radio" name="residence" value="apartment" className="mr-2 h-4 w-4 text-orange-600 focus:ring-orange-500 border-slate-400"/> Apartment</label>
                        <label className="flex items-center"><input type="radio" name="residence" value="house" className="mr-2 h-4 w-4 text-orange-600 focus:ring-orange-500 border-slate-400"/> House</label>
                        <label className="flex items-center"><input type="radio" name="residence" value="other" className="mr-2 h-4 w-4 text-orange-600 focus:ring-orange-500 border-slate-400"/> Other</label>
                    </div>
                </div>
                <div className="mt-4">
                    <label className={labelStyles}>Do you own or rent your home?</label>
                    <div className="mt-2 flex flex-wrap gap-x-6 gap-y-2 text-slate-700 dark:text-slate-300">
                        <label className="flex items-center"><input type="radio" name="ownRent" value="own" className="mr-2 h-4 w-4 text-orange-600 focus:ring-orange-500 border-slate-400"/> Own</label>
                        <label className="flex items-center"><input type="radio" name="ownRent" value="rent" className="mr-2 h-4 w-4 text-orange-600 focus:ring-orange-500 border-slate-400"/> Rent</label>
                    </div>
                </div>
            ...
            <fieldset className="border-t border-slate-300 dark:border-slate-700 pt-5">
                <legend className="text-xl font-semibold text-slate-700 dark:text-slate-200 mb-3">Pet Experience</legend>
                 <div>
                    <label htmlFor="experience" className={labelStyles}>Please describe your experience with pets.</label>
